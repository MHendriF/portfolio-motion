      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 text-neutral-700 items-center flex space-x-1 dark:hover:text-neutral-300 hover:text-neutral-500"
            )}
          >
