...
export const BentoGridItem = ({
  ...
  const rightLists = ["VueJS", "Laravel", "RestAPI"];
  ...
  const handleCopy = () => {
    const text = "hendrifebriansyah28@gmail.com";
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          <div className={`font-sans text-lg lg:text-3xl max-w-96 font-bold z-10 text-white-100`}>{title}</div>
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-6">
                {leftLists.map((item, i) => (
                  <span
                    ...
                    lg:opacity-100 rounded-lg text-center bg-[#9ca3dc] dark:bg-[#10132E]"
                  >
                    {item}
                  </span>
                ))}
                <span className="lg:py-3 lg:px-3 py-3 px-3  rounded-lg text-center bg-[#9ca3dc] dark:bg-[#10132E]"></span>
              </div>
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-6">
                <span className="lg:py-3 lg:px-3 py-3 px-3  rounded-lg text-center bg-[#9ca3dc] dark:bg-[#10132E]"></span>
                {rightLists.map((item, i) => (
                  <span
                    key={i}
                    className="lg:py-3 lg:px-3 py-2 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#9ca3dc] dark:bg-[#10132E]"
                  >
                    {item}
                  </span>
                ))}
